...
design_libs=(xpm axi_infrastructure_v1_1_0 fifo_generator_v13_2_11 axi_clock_converter_v2_1_32 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work fifo_generator_v13_2_11 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
  ...
  vlogan -work axi_clock_converter_v2_1_32 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \

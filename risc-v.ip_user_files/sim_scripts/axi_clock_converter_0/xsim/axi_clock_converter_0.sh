...
export RDI_DATADIR="/xilinx/tools/Xilinx/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L fifo_generator_v13_2_11 -L axi_clock_converter_v2_1_32 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_clock_converter_0 xil_defaultlib.axi_clock_converter_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/xilinx/tools/Xilinx/Vivado/2024.2/data/xsim"
  fi

...
proc create_root_design { parentCell } {
  ...
  # Create instance: riscv_cpu_wrapper_0, and set properties
  set block_name riscv_cpu_wrapper
  set block_cell_name riscv_cpu_wrapper_0
  if { [catch {set riscv_cpu_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $riscv_cpu_wrapper_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net riscv_cpu_wrapper_0_m_axi [get_bd_intf_pins riscv_cpu_wrapper_0/m_axi] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  [get_bd_pins riscv_cpu_wrapper_0/clk] \
  ...
  [get_bd_pins riscv_cpu_wrapper_0/btn_reset_n]

  # Create address segments
  assign_bd_address -offset 0x00000700 -range 0x00000080 -target_address_space [get_bd_addr_spaces riscv_cpu_wrapper_0/m_axi] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
